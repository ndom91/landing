...
// svgGoogle - google logo in svg path - outputting "undefined" atm.. so back to string it is!
...
// var svgNT   = "<svg style=\"width:24px;height:24px\" xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 256 256\"><path id=\"Selection #3\" fill=\"white\" stroke=\"black\" stroke-width=\"0\" d=\"M 34.00,68.00 C 34.00,68.00 43.62,68.57 43.62,68.57 43.62,68.57 52.00,76.00 52.00,76.00 52.02,78.25 51.83,78.37 54.00,79.00 54.50,82.96 60.14,91.86 64.00,93.00 64.52,97.18 74.56,109.78 77.64,114.00 79.64,116.75 80.67,119.02 84.00,120.00 84.91,124.42 91.62,135.72 96.00,137.00 96.00,137.00 98.00,142.00 98.00,142.00 98.00,142.00 98.00,68.00 98.00,68.00 98.00,68.00 127.00,68.00 127.00,68.00 127.00,68.00 127.00,196.00 127.00,196.00 127.00,196.00 104.00,196.00 104.00,196.00 94.53,195.82 93.99,190.52 89.24,183.91 89.24,183.91 77.92,169.00 77.92,169.00 75.60,165.80 73.96,161.17 70.00,160.00 69.80,157.22 69.71,156.77 67.00,156.00 66.56,152.50 61.36,144.07 58.00,143.00 58.00,143.00 44.00,122.00 44.00,122.00 44.00,122.00 44.00,196.00 44.00,196.00 44.00,196.00 15.00,196.00 15.00,196.00 15.00,196.00 15.00,68.00 15.00,68.00 15.00,68.00 34.00,68.00 34.00,68.00 Z M 247.00,69.00 C 247.00,69.00 247.00,95.00 247.00,95.00 247.00,95.00 205.00,95.00 205.00,95.00 205.00,95.00 205.00,198.00 205.00,198.00 205.00,198.00 177.00,198.00 177.00,198.00 177.00,198.00 177.00,95.00 177.00,95.00 177.00,95.00 135.00,95.00 135.00,95.00 135.00,95.00 135.00,69.00 135.00,69.00 135.00,69.00 247.00,69.00 247.00,69.00 Z\"/></svg>";
// // NT FILL - #67B236
// var faSocial = "<i class=\"fas fa-share-square fa-lg\"></i>";
// var faPersonal = "<i class=\"fas fa-user-alt fa-lg\"></i>";
// var faCode = "<i class=\"fas fa-terminal fa-lg\"></i>";
// var faSearch = "<i class=\"fab fa-searchengin fa-lg\"></i>";
// var faNDO2 = "<i class=\"fab fa-neos fa-lg\"></i>";
...
// var linkMenu = [
//   [svgNT,                   "white",                                        "-HEAD-"], // Anime
//   ["Git", "https://git.newtelco.de",""],
//   ["Build", "https://build.newtelco.de",""],
//   ["CRM", "https://crm.newtelco.de",""],
//   ["IT Admins", "https://it.newtelco.de",""],
//
//   [faSocial,                  "white",                                       "-HEAD-"], // Media
//   ["YouTube",                  "",""],
//   ["Facebook",                 "",""],
//   ["Reddit",                   "",""],
//   ["Twitch",                   "",""],
//   ["DeviantArt",               "",""],
//
//   [faPersonal,                  "white",                                        "-HEAD-"], // 4chan
//   ["/a/ Anime & Manga",        "",""],
//   ["/g/ Technology",           "",""],
//   ["/w/ Anime/Wallpapers",     "",""],
//   ["/wg/ Wallpaper/General",   "",""],
//
//   [faCode,                    "white",                                         "-HEAD-"], // Code Stuff
//   ["GitHub", "https://github.com/ndom91",""],
//   ["Gist",                     "",""],
//   ["JSFiddle",                 "",""],
//   ["Stack Overflow",           "",""],
//
//   [faSearch,                 "white",                                     "-HEAD-"], // Gaming
//   ["Steam",                    "",""],
//   ["Humble Bundle",            "",""],
//   ["GOG.com",                  "",""],
//   ["/r/gaming",                "",""],
//
//   [faNDO2,                    "white",                                      "-HEAD-"], // Other
//   ["Gmail",                    "",""],
//   ["Amazon",                   "",""],
//   ["Dropbox",                  "",""],
//   ["Netflix",                  "",""],
...
function initSearchBar() {
  if (searchSources[ssi] !== undefined)
    ...
    $('#searchBar').attr("placeholder", "WHERE TO, M8");
  else {
    ssi = 0;
